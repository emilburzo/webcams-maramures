...
<div id="webcam_cavnic_wrapper" class="cam">
    ...
    <script>
        $(function () {
            ...
            var player = jwplayer(id);
            player.setup({
                file: 'https://cloud.freecam.ro:5443/LiveApp/streams/828770831645636671004007.m3u8',
                height: 376,
                width: 504,
                autostart: true,
                mute: true,
...
<div id="webcam_cavnic2_wrapper" class="cam">
    ...
    <script>
        $(function () {
            ...
            var player = jwplayer(id);
            player.setup({
                file: 'https://cloud.freecam.ro:5443/LiveApp/streams/760748575099125852227274.m3u8',
                height: 376,
                width: 504,
                autostart: true,
                mute: true,
...
<div id="webcam_cavnic3_wrapper" class="cam">
    ...
    <script>
        $(function () {
            ...
            var player = jwplayer(id);
            player.setup({
                file: 'https://cloud.freecam.ro:5443/LiveApp/streams/073706757735866848843790.m3u8',
                height: 376,
                width: 504,
                autostart: true,
                mute: true,
